...
public class ArraySearch {
    ...
    /**
     * επιστρέφει την θέση του πρώτου στοιχείου του πίνακα που ισούται
     * με την τιμή αναζήτησης (value). Αν δεν υπάρχει το στοιχείο,
     * επιστρέφει -1.
     * @param arr ο input πίνακας
     * @param value η τιμή αναζήτης
     * @return το Position που βρέθηκε το στοιχείο, αλλίως -1.
     */
