...
public class Account {
    ...
    public void deposit(double amount) throws NegativeAmountException {
        try {
            if (amount < 0) throw new NegativeAmountException("The amount" + amount + " should  not be negative");
            balance += amount;
    ...
    public void withdraw(double amount, String ssn) throws NegativeAmountException, InsufficientBalanceException, SsnNotValidException {
        try {
            ...
            if (amount > balance) throw new InsufficientBalanceException("The balance= " + this.balance + " is insufficient");
    ...
    /**
     * @return the current balance of the amount.
     */
...
//        return getBalance();
    ...
    public String accountToString() {
        return "Account: " + id + " IBAN: " + iban + " Firstname: " + firstname + " Lastname: " + lastname +
