...
public class FileWriterJavaIo {
    ...
    public static void main(String[] args) {
        File file = new File("C:/Users/Χριστίνα/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file.txt");

        try (PrintStream ps = new PrintStream("C:/Users/Χριστίνα/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file-ps.txt")){
